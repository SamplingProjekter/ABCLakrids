...
\end{equation*}
Her er $e_{ij}$ de forventede værdier. Tabeller over disse er vedlagt i Bilag1 og Bilag2. Jævnfør Cochrans regel(ref?) skal alle de forventede v?rdier v?re st?rre eller lig 1, og h?jst 20% m? v?re mindre end 5, får vi kan bruge en $\chi^2$-approximation. I Bilag1 ses de forventede værdier, og vi ser, at de langt fra opfylder Cochrans regel, da ingen af dem er større end 5. Derfor grupperes bogstaverne i grupper af tre, og vi får da 9 grupper istedet for 27. Dette nye data samt de forventede værdier er angivet i Bilag2. Disse forventede værdier opfylder Cochrans regel, da de alle er større end 5.   
...
## Bilag1
\begin{center}
\includegraphics[width=8in]{C:/Users/Lina/Documents/Sampling/ForventedeVardierUdenInddeling.pdf}
\end{center}

## Bilag2
\begin{center}
\includegraphics[width=8in]{C:/Users/Lina/Documents/Sampling/GruperetDataOgForventedeVardier.pdf}
\end{center}
